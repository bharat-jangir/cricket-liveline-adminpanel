...
export function SeriesTeamsTab() {
  ...
  const [activeFormat, setActiveFormat] = useState<'ODI' | 'T20' | 'Test'>('ODI');
                          ...
                          {isEditing ? (
                            <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                                <button
                                  ...
                                  className={`size-8 shrink-0 rounded-full flex items-center justify-center text-[10px] font-bold border transition-colors ${
                                    squadPlayer.isCaptain
